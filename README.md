...
- **No real-data integration yet.** Cross-sectional (ABIDE I) integration is week 4. Longitudinal integration targets a public OpenNeuro accession and is week 4 at the earliest, contingent on an accession that actually ships FreeSurfer `.stats` files alongside ≥2 structural sessions per subject.
