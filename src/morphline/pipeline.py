...
def run_pipeline(
    ...
    *,
    ...
    accounting = build_accounting(
        ...
        observations_expected=ingested.observations_expected,
        observation_losses=ingested.observation_losses,
        regions_per_session=ingested.regions_per_session,
        measures_per_file=ingested.measures_per_file,
        measures_overwritten=ingested.measures_overwritten,
